    ...
    public static class Host
    {
        ...
        public static void CleanQueue(string hostName)
        {
            ...
            if (noMessageInstances > 0)
            {
                ...
                if (noMessageInstances > 0)
                {
                    throw new BizTalkExtensionsException("There are still message instances in the message box, check the host has been stopped");
                }
            }
            ...
            if (noServiceInstances > 0)
            {
                ...
                if (noServiceInstances > 0)
                {
                    throw new BizTalkExtensionsException("There are still service instances in the message box, check the host has been stopped");
                }
            }
        }
